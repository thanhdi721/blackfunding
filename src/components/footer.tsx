...
export default function Footer() {
  return (
    <footer className="bg-[linear-gradient(131deg,#000_0%,#272525_30.66%,#272525_62.3%,#000_98.34%)] bottom-0 left-0 right-0 border-t py-3 mx-3 rounded-2xl border border-[#333]">
      <div className="mx-auto px-2 md:px-4">
        <div className="flex flex-col items-center justify-center relative gap-12 md:flex-row md:items-center md:justify-between">
          <div className="flex justify-between items-center w-full pb-12 md:pb-0">
          ...
          <div className="absolute top-1/2 md:top-0 left-1/2 -translate-x-1/2 bg-[linear-gradient(131deg,#000_0%,#272525_30.66%,#272525_62.3%,#000_98.34%)] p-1 md:p-2 rounded-xl border border-[#333]">
